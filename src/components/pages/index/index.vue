<template>
  <div class="page" @scroll="scrollHandle($event)" @touchmove="scrollHandle($event)">
    ...
    <!-- 推荐市场 -->
    <recommendM :newArr="indexData.recommendMarket"></recommendM>
    <!-- 分割距离 -->
    <div class="grayBlank">
    </div>
    <!-- 折扣专区 -->
    <discountA :newObjBanner="indexData.discountData.banner" :newObjList="indexData.discountData.list.list"></discountA>
    <!-- 分割距离 -->
    <div class="grayBlank">
    </div>
    <storeC :newObjBanner="indexData.storeData.banner" :newObjList="indexData.storeData.list"></storeC>
    <!-- 分割距离 -->
    <div class="grayBlank">
    </div>
    <productC :newObjBanner="indexData.productData.banner" :newObjList="indexData.productData.list"></productC>
    <!-- 分割距离 -->
    <div class="grayBlank">
    </div>
    <decorationC :newObjBanner="indexData.caseData.banner" :newObjList="indexData.caseData.list"></decorationC>
    <!-- 分割距离 -->
    <div class="grayBlank">
    </div>
    <learnD :newObjBanner="indexData.materialData.banner" :newObjList="indexData.materialData.list"></learnD>
    <!-- 分割距离 -->
    <div class="grayBlank">
    </div>
    <platformR></platformR>
      ...
      this.tool
        ...
        .then(res => {
          if (res.status == 200) {
            ...
            this.indexData.recommendMarket = res.data.market.list.list; //推荐市场
            this.indexData.discountData = res.data.discount; //折扣专区
            this.indexData.storeData.banner = res.data.shop.banner; //店铺精选
            this.indexData.storeData.list = res.data.shop.list.list;

            this.indexData.productData.banner = res.data.goods.banner; //商品精选
            this.indexData.productData.list = res.data.goods.list.list;

            this.indexData.caseData.banner = res.data.case.banner; //装修案例
            this.indexData.caseData.list = res.data.case.list.list;

            this.indexData.materialData.banner = res.data.material.banner; //学装修
            this.indexData.materialData.list = res.data.material.list.list;
          }
        });
    }
  }
