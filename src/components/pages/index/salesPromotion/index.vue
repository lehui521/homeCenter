<template>
  <div class="pages">
    ...
    <div class="banner" v-for="(item) in detail.banner" :key="item.banner_id">
    ...
    <div class="marketActive" v-if="status.tabStatus=='market'">
      <div class="active" v-for="(item) in detail.list.list" :key="item.activity_id">
        <div class="activeImg">
          <img :src="item.image" alt="">
        </div>
    ...
    methods: {
      ...
      getData() {
        let param = {
          ...
          params: {
            type: this.tabStatus == 'market' ? 1 : 2,
