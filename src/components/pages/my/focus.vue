<template>
  <div class="page">
    ...
    <div class="content">
      <ul class="list">
        <li class="item" @click="$router.push('focusContentCompany')">
        ...
        <li class="item" @click="$router.push('focusContentStore')">
          <div class="relativeItem">
            <div class="thumb">
              <!-- <img src="static/img/demo.jpg" alt=""> -->
              <div class="thumb-demo"></div>
        ...
        <li class="item" @click="$router.push('focusContentDesigner')">
          <div class="relativeItem">
            <div class="thumb">
              <!-- <img src="static/img/demo.jpg" alt=""> -->
              <div class="thumb-demo"></div>
